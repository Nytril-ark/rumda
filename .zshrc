...
#
#
# custom 24-bit colors
C_MAGENTA=$'%{\e[1;38;2;186;199;221m%}'   # #BAC7DD
C_GREEN=$'%{\e[1;38;2;45;104;128m%}'     # #2D6880
RESET=$'%{\e[0m%}'
...
# Updated PS1
PS1="[$C_USER$USER$C_AT@$C_HOST$HOST $C_ERR%3~%(0?..$C_ERR%?)%{${fg[blue]}%} $RESET]"
