      ...
      Repeater {
        ...
        delegate: Item {
          ...
          Shape {
            ...
            ShapePath {
              fillColor: (workspaceItem.modelData.active || workspaceItem.hovered) ? Colors.gradientAccent2Color : Colors.indicatorBGColor
          ...
          MouseArea {
            ...
            onWheel: wheel => {
              ...
              Hyprland.dispatch("workspace e" + direction);
            }
          }
        }
      }
