    ...
    ColumnLayout {
      ...
      Item {
        ...
        Rectangle {
          ...
          anchors.bottom: parent.bottom
          anchors.left: parent.left
          anchors.leftMargin: mouseAreaMiddle.containsMouse ? buttonFloatAmount + middleButtonsCircularOffset + centerButtonCircularOffset : middleButtonsCircularOffset + centerButtonCircularOffset + allButtonsOffset
