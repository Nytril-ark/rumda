...
Singleton {
  ...
  readonly property string cConfigPath: Quickshell.env("HOME") + "/.config/rumda-pistachio/common/quickshell"
  readonly property string cProfilePath:  Quickshell.env("HOME") + "/.config/rumda-pistachio/pictures/gatoInPan.png"  // profile pic in the dashboard
